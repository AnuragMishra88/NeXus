...
import QuizBank from './Component/Academic/Quiz/QuizBank';
      ...
      <div className="main-container">
        ...
        <div className="content">
          <Routes>
            ...
            <Route
              path="/"
              element={<Homepage setActivePage={setActivePage} selectedMode={selectedMode} />}
            />
            <Route
              path="/Academic"
              element={<Homepage setActivePage={setActivePage} selectedMode="Academic" />}
            />
            <Route
              path="/Career"
              element={<Homepage setActivePage={setActivePage} selectedMode="Career" />}
            />

            {/* Auth Routes */}
            <Route
              path="/signin"
              element={user ? <Navigate to="/" /> : <SignIn setActivePage={setActivePage} />}
            />
            <Route
              path="/register"
              element={user ? <Navigate to="/" /> : <Register setActivePage={setActivePage} />}
            />

            {/* Profile (Protected) */}
            <Route
              path="/profile"
              element={user ? <Profile setActivePage={setActivePage} /> : <Navigate to="/signin" />}
            />
            ...
            <Route path="/quiz-bank" element={<QuizBank setActivePage={setActivePage} />} />
